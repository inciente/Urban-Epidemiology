...
addpath('/home/noel/Documents/RUDDS Final/RUDDS_Software/')
...
% 
% % Visualize a variable inside the city grid
% load('my_colormaps.mat');
% 
% figure; hold on;
% fill(grid.X, grid.Y, city.TAS_adult)
% colormap(my_colormaps.cnight);
% 
% scatter(city.hospitals.public(:,1), city.hospitals.public(:,2),50, ...
%     'MarkerEdgeColor',[0 0 0],'MarkerFaceColor',[64 178 109]/255, ...
%     'LineWidth',1.5);
% scatter(city.hospitals.private(:,1), city.hospitals.private(:,2),50, ...
%     'MarkerEdgeColor',[0 0 0],'MarkerFaceColor',[239 160 64]/255, ...
%     'LineWidth',1.5);
% 
% figure; hold on
% fill(grid.X, grid.Y, city.TAS_child)
% colormap(my_colormaps.cnight)
